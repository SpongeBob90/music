<template>
  <scroll class="listview" :data="data" ref="listView" :listenScroll="listenScroll" @scroll="scroll" :probeType="probeType">
    ...
    <div class="list-shortcut" @touchstart="onShortcutTouchstart" @touchmove.stop.prevent="onShortcutTouchMove">
      <ul>
        <li v-for="(item, index) in shortcutList" class="item" :class="{'current':currentIndex===index}" @click="onShortcutClick" :data-index="index" :key="index">
          {{item}}
        </li>
      </ul>
    </div>
...
export default {
  ...
  methods: {
    ...
    onShortcutClick(e) {
      let toIndex = getData(e.target, 'index')
      this.scrollY = -this.listHeight[toIndex]
